...
#ifndef NON_REPORT_MONTHLY_H
#define NON_REPORT_MONTHLY_H

#include <memory>

using namespace std;

class Report_Non_Monthly {
private:
...
public:
	...
	Report_Non_Monthly(int t_initial, int t_rate, int t_years) : m_initialInvestment(t_initial), m_annualRate(t_rate), m_years(t_years) {}
